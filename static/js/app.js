...
function runFilter() {
  ...
  var filteredData = sightings.filter(x => x.datetime === inputValue_date && x.city === inputValue_city && x.state === inputValue_state && x.country === inputValue_country && x.shape === inputValue_shape && x.durationMinutes === inputValue_duration);
